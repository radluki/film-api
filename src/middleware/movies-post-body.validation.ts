...
import { getString255Validator, validate, validateBodyFieldNames } from "./validation-utils";
import { genresValidator } from "./genres-validation";

const MOVIE_FIELDS = ['title', 'year', 'runtime', 'director', 'genres', 'actors', 'plot', 'posterUrl'];
const validateMovieBodyFieldNames = (value) => validateBodyFieldNames(value, MOVIE_FIELDS)
